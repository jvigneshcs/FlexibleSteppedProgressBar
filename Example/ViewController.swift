...
class ViewController: UIViewController, FlexibleSteppedProgressBarDelegate {
    ...
    func setupProgressBarWithoutLastState() {
        ...
        progressBarWithoutLastState.progressRadius = 20
    ...
    func setupProgressBarWithDifferentDimensions() {
        ...
        progressBarWithDifferentDimensions.currentSelectedCenterStartedColor = progressColor
    ...
    func setupProgressBar() {
        ...
        progressBar.currentSelectedCenterStartedColor = progressColor
